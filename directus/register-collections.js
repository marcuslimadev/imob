...
const collections = {
    ...
    pessoa_contatos: {
        meta: {
            collection: 'pessoa_contatos',
            icon: 'contact_phone',
            note: 'Múltiplos contatos por pessoa/lead (telefones, emails)',
            display_template: '{{tipo}}: {{contato}}',
            hidden: false,
            singleton: false,
            accountability: 'all',
            color: '#10B981',
    ...
    vistorias: {
        meta: {
            ...
            display_template: '{{codigo}} - {{tipo}} - {{status}}',
            hidden: false,
            singleton: false,
            accountability: 'all',
            color: '#10B981',
    ...
    vistoria_itens: {
        meta: {
            ...
            icon: 'checklist',
            note: 'Itens verificados em cada vistoria (cômodos, estado)',
    ...
    vistoria_contestacoes: {
        meta: {
            ...
            icon: 'gavel',
            note: 'Contestações/divergências em vistorias',
            display_template: '{{vistoria_id.codigo}} - {{status}}',
            hidden: false,
            singleton: false,
            accountability: 'all',
            color: '#F59E0B',
