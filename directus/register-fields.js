...
const fieldsDefinitions = {
    companies: [
        ...
        { field: 'storefront_template_id', type: 'integer', meta: { interface: 'select-dropdown', width: 'half', note: 'Template da vitrine pública (1-20)', options: { choices: [
            { text: 'Template 1 - Padrão', value: 1 },
            ...
            { text: 'Template 11 - Dark Mode Avançado', value: 11 },
    ...
    properties: [
        ...
        { field: 'edificio_condominio', type: 'string', meta: { interface: 'input', width: 'half', note: 'Nome do edifício ou condomínio' } },
    ...
    pessoa_contatos: [
        ...
        { field: 'descricao', type: 'string', meta: { interface: 'input', width: 'full', note: 'Descrição adicional (ex: Comercial, Pessoal, Mãe)' } },
        { field: 'principal', type: 'boolean', meta: { interface: 'boolean', width: 'half', note: 'Este é o contato principal?' } },
    ],
    ...
    vistorias: [
        { field: 'codigo', type: 'string', meta: { interface: 'input', width: 'half', note: 'Código único da vistoria (ex: VST-2025-001)' } },
        ...
        { field: 'tipo', type: 'string', meta: { interface: 'select-dropdown', width: 'half', required: true, options: { choices: [ { text: 'Entrada', value: 'entrada' }, { text: 'Saída', value: 'saida' }, { text: 'Periódica', value: 'periodica' } ] } } },
        { field: 'status', type: 'string', meta: { interface: 'select-dropdown', width: 'half', required: true, default_value: 'solicitada', options: { choices: [ { text: 'Solicitada', value: 'solicitada' }, { text: 'Designada', value: 'designada' }, { text: 'Em Andamento', value: 'em_andamento' }, { text: 'Concluída', value: 'concluida' }, { text: 'Cancelada', value: 'cancelada' } ] } } },
    ...
    vistoria_itens: [
        ...
        { field: 'estado', type: 'string', meta: { interface: 'select-dropdown', width: 'half', required: true, options: { choices: [ { text: 'Ótimo', value: 'otimo' }, { text: 'Bom', value: 'bom' }, { text: 'Regular', value: 'regular' }, { text: 'Ruim', value: 'ruim' }, { text: 'Péssimo', value: 'pessimo' } ] } } },
        { field: 'observacoes', type: 'text', meta: { interface: 'input-multiline', width: 'full' } },
    ...
    vistoria_contestacoes: [
        ...
        { field: 'contestante', type: 'string', meta: { interface: 'select-dropdown', width: 'half', required: true, options: { choices: [ { text: 'Locatário', value: 'locatario' }, { text: 'Proprietário', value: 'proprietario' }, { text: 'Imobiliária', value: 'imobiliaria' } ] } } },
        { field: 'motivo', type: 'text', meta: { interface: 'input-rich-text-html', width: 'full', required: true } },
        { field: 'status', type: 'string', meta: { interface: 'select-dropdown', width: 'half', required: true, default_value: 'apontada', options: { choices: [ { text: 'Apontada', value: 'apontada' }, { text: 'Em Análise', value: 'em_analise' }, { text: 'Aceita', value: 'aceita' }, { text: 'Rejeitada', value: 'rejeitada' }, { text: 'Finalizada', value: 'finalizada' } ] } } },
        { field: 'resposta', type: 'text', meta: { interface: 'input-rich-text-html', width: 'full' } },
        { field: 'anexos', type: 'json', meta: { interface: 'list-m2m', width: 'full', note: 'Array de file IDs (evidências)' } },
        { field: 'created_at', type: 'timestamp', meta: { interface: 'datetime', width: 'half', readonly: true, special: ['date-created'] } },
        { field: 'updated_at', type: 'timestamp', meta: { interface: 'datetime', width: 'half', readonly: true, special: ['date-updated'] } },
    ],
