...
import { ContatosManager } from "@/components/pessoa/ContatosManager";
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Adicione múltiplos telefones, emails e outros contatos. Marque o principal para identificação rápida.
                  </p>
                </div>
                <ContatosManager leadId={form.id} companyId={companyId} />
                
                <div className="mt-6 pt-6 border-t">
                  <div className="space-y-2">
                    <label className="text-sm font-semibold">Notas e observações gerais</label>
                    <Textarea
                      value={form.notes || ""}
                      onChange={(e) => setField("notes", e.target.value)}
                      placeholder="Preferências, restrições, detalhes de visitas ou informações adicionais."
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-dashed px-4 py-3">
              <div className="flex flex-wrap gap-2 text-sm text-muted-foreground">
                ...
                {form.id && <span className="bauhaus-pill">Contatos múltiplos disponíveis</span>}
              </div>
              <div className="flex gap-2">
